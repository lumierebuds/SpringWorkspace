...
<body>
   ...
   <div class="outer">
      ...
      <form id="enroll-form" action="${contextPath }/member/insert" method="post">
         <!-- 회원가입form안에.txt -->
         <table align="center">
            <tr>
               <td>* ID</td>
   ...
   <script>
      function idCheck(){
         ...
         $.ajax({
            url : "idCheck" , // "/spring/member/idCheck" - ""/spring/member/insert" 경로 페이지에서 마지막 슬래시 위치에서 "idCheck"가 붙음
            data : {
               userId : $userId.val()
            },
